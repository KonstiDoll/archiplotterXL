    ...
    <div id="mainContainer" class="relative flex flex-row h-screen w-full overflow-hidden">
        <div id='sidebar'
            ...
            <div class="w-full bg-slate-800 p-2 overflow-auto">
                ...
                <div class="space-y-3">
                    <div v-for="(tool, index) in tools" :key=index class="flex flex-row items-center space-x-2">
                        <!-- Tool-Button -->
                        <div class="bg-slate-400 h-14 !w-14 rounded-lg flex flex-col items-center justify-center hover:bg-slate-500 hover:cursor-pointer active:bg-orange-700"
                        ...
                        <select v-model="toolPenTypes[index]" class="p-1 flex-grow border rounded bg-white">
                ...
                <div class="mt-2 text-xs text-white p-1 bg-slate-700 rounded">
                    Hinweis: Die Stift-Zuordnung wirkt sich auf alle SVGs aus, die mit dem entsprechenden Werkzeug
                    gezeichnet werden.
                </div>
            </div>
        ...
        <div id="content" class="relative flex flex-col w-5/6 h-full p-6 bg-slate-200/0 rounded-xl overflow-scroll">
            <div class="flex flex-row justify-center">
                <div
                    ...
                    <input class="opacity-0 absolute w-full h-full" type="file" @change="handleImageUpload"
                        accept="*" />
