...
; Drives
M569 P0 S0 D3                  ; XL physical drive 0 goes forwards, sensorless homing
M569 P1 S1 D3                  ; Y  physical drive 1 goes forwards, sensorless homing
M569 P3 S1 D3                  ; U ottom physical drive 2 goes forwards, sensorless homing
M569 P5 S1 D3 ;V10000            ; XR physical drive 5 goes backwards, sensorless homing, hybrid speed
...
M92 X853.33 Y711.1 Z17066.67 U88.96        ; set steps per mm
...
M208 X2340 Y1864 Z70 U35.1 S0        ; set axis maxima

; Endstops
M574 X2 S3                    ; configure endstop for high end on X
...
M557 X15:2340 Y15:1864 S193                ; define mesh grid
