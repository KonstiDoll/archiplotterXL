...
pump_distance = 250              # set to 0 to disable; millimeters between pumping action 
#line_number = 0
drawing_length = 0.0
drawing_x1 = 0.0
drawing_y1 = 0.0
...
with open(file_name, 'r+') as f:
    ...
    for line in content:
        #print(line)
        pref_list = [ 'G0 ', 'G1 ', 'G2 ', 'G3 ', 'M226']   #considered beginnings of line
